...
<head>
    ...
    <title>Contact | The Forgotten India</title>
</head>
...
<body>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900"><u>Contact Us</u></h1>
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <button type="button" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" id="submit">Submit</button>
        </div>
      </div>
    </div>
    </form>
...
<script>
    ...
    button.addEventListener("click", ()=>{
        ...
        footer: '<p>Hint: SMTP not setup Yet!</p>'
        });
    });
</script>
</body>
